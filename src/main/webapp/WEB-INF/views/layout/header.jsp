                    ...
                    <ul class="nav pull-right">
                        <li id="fat-menu" class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="account-button">
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="/show_profile">Show details</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="/edit_profile">Edit account</a></li>
